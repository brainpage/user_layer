function drawChart(){
	...
	var bar_m = [0, 10, 10, 100],
	    bar_w = 400 - bar_m[1] - bar_m[3],
	    bar_h = 200 - bar_m[0] - bar_m[2];
	...
	function zoomLine(app){
	    ...
	    var	data = flatten_array.filter(function(d){return d.name == app});
		...
		var svg = d3.select("#zoom-line").append("svg")
